...
class TasksPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Task> list = [
      Task(id: '1', title: 'Read emails from mailbox', dateTime: now, description: loremDesc),
      Task(id: '2', title: 'Check latest news on Flutter', dateTime: now, description: loremDesc),
    ];
    return Row(
      children: [
        Expanded(
        ...
        VerticalDivider(width: AppDimens.xs),
        Expanded(
          flex: 1,
          child: Container(),
        ),
